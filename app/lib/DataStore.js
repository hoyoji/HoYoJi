( function() {
		exports.DataStore = {
			...
			initStore : function() {
				var collections = ["Login","User","UserData", "Picture","Project","ParentProject","ProjectShareAuthorization","MoneyExpenseCategory","MoneyIncomeCategory","FriendCategory","Currency","Exchange","MoneyAccount","Friend","Message","MessageBox","MoneyExpense","MoneyIncome","MoneyExpenseDetail","MoneyIncomeDetail","MoneyExpenseApportion","MoneyIncomeApportion","MoneyTransfer","MoneyBorrow","MoneyReturn","MoneyLend","MoneyPayback","MoneyBorrowApportion","MoneyLendApportion","MoneyReturnApportion","MoneyPaybackApportion","ClientSyncTable", "ProjectRemark"];
